...
st.sidebar.header('Parametri Elaborazione')
threshold = st.sidebar.slider('Soglia Curve (gradi)', 5.0, 45.0, 15.0, 1.0)
simplify = st.sidebar.slider('Semplificazione tracciato (metri)', 0.1, 10.0, 2.0, 0.5)
...
if run_job:
    ...
    with st.spinner('Converto GPX in KML...'):
        for gpx_path in gpx_files:
            ...
            python_command = [
                'python3', 'curve_detector.py', 
                str(gpx_path), str(kml_path),
